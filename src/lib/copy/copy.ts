...
// Fuente: MENSAJE-MAESTRO-GrupoCISA.docx + COPY-Home-v2.md
...
export const copy = {
  ...
  hero: {
    ...
    ctaSecundario: 'Conoce la empresa ↓',
  ...
  // Bloque 5 · Equipo
  equipo: {
    titular: 'Detrás de cada proyecto hay nombres, no un logotipo.',
    parrafo: 'Un desarrollo es una relación de años. Conviene saber con quién la estás empezando.',
    pendientes: 3
  },
